...
cloudstream {
    authors     = listOf("kraptor", "Phisher98", "Hexated")
    language    = "id"
    ...
    iconUrl = "https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://tv11.lk21official.cc&size=256"
}